#!/usr/bin/env python3
"""Local browser UI for Partition Lab.
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the local Partition Lab UI.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.json:
        ...
        print(f"Partition Lab UI running at {url}")
